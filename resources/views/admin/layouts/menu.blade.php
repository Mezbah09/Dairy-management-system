<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="{{ route('admin.dashboard')}}"><img src="{{ asset('backend/images/logo.svg') }}" width="25" alt="Aero"><span class="m-l-10">Dairy Management</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
            ...
            <li><a href="javascript:void(0);" class="waves-effect waves-block menu-toggle"><i class="zmdi zmdi-shopping-cart"></i><span>Staff Manage</span></a>
                <ul class="ml-menu">
                    ...
                    <li><a href="{{ route('admin.employee.ret') }}" class="waves-effect waves-block">Balance Return</a></li>
                </ul>
            </li>
            ...
            {{-- </li> --}}
            @endif
            @if (session('key_12ee3nnn'))
                <li><a href="{{ route('super-logout') }}" class="waves-effect waves-block" target="_top"><i class="zmdi zmdi-power"></i><span>Super Log out</span></a></li>
            @endif
