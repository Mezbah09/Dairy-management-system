    ...
    <form id="form_validation" method="POST" onsubmit="return saveData(event);">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <input type="date" name="date" id="" class="form-control next" data-next="u_id">
            </div>
            ...
            <div class="col-lg-3">
                ...
                <input type="number" id="amount" min="0" name="amount" class="form-control next" data-next="save" placeholder="Enter advance amount" required>
            </div>
            <div class="col-lg-2">
