...
<div>
    <table class="table-bordered table">
        ...
        <tr>
            <td>Total Milk amount for pay</td>
            <td>{{ $milkPayment }} </td>
            <td></td><td></td><td></td>
        </tr>
        {{-- <tr>
        ...
        @php
        if ($type == 3) {
            $outtot = $milkPayment + $expense  + $empSalary + $supplier + $totlaSalary;
        } else {
            $outtot = $milkPayment + $expense  + $empSalary + $supplier;
        }
        ...
        @php
            $incomtot =  $sellItems + $distributorSell + $billing;
