...
<div class="row">
    <div class="col-md-6">
        <label for="">Avoid Center</label>
        <select name="ex[]" id="ex" multiple class="form-control show-tick ms select2">
            @foreach (\App\Models\Center::select('id','name')->get() as $center)
