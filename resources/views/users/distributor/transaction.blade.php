...
@section('title','Distributor Transaction')
@section('css')
...
<div >
    <div class="row">
        ...
        <div class="col-md-3 mt-2 col-6 ct ct-0 ct-2 ct-3 ct-4 d-none">
            <label for="date">Year</label>
            <select name="year" id="year" class="form-control show-tick ms select2">
            </select>
        </div>
        <div class="col-md-3 mt-2 col-6 ct ct-0  ct-2 ct-3 d-none">
            <label for="date">Month</label>
            <select name="month" id="month" class="form-control show-tick ms select2">
            </select>
        </div>
        <div class="col-md-3 mt-2 col-6 ct ct-2 d-none">
        ...
        <div class="col-md-3 mt-2 col-6 ct ct-0 d-none">
        ...
        <div class="col-md-3 mt-2 col-6 ct ct-1 ct-5 d-none">
            <label for="Date1">Date1</label>
            <input type="text" id="date1" class="form-control calender">
        </div>
        <div class="col-md-3 mt-2 col-6 ct ct-5 d-none">
...
<script>
    ...
    function loadData(){
        ...
        axios({
                method: 'post',
                url: '{{ route("distributer.loaddata")}}',
                data:data ,
        })
